module Terminfo
  ...
  module Alias
    ...
    Strings = {
      ...
      # The following string capabili[ies are present in the SVr4.0 term structure, but were originally not documented in the man page.


      #         Variable             [info      TCap     Description
      #          String              [ame       Code
